...
function trataAutorizaçaoSucesso(payloadToken) {
  selecionarDocumento({ nomeDocumento, usuario: payloadToken.nomeUsuario });
...
export { atualizaTextoEditor, alertarERedirecionar, trataAutorizaçaoSucesso, atualizarInterfaceUsuarios};
